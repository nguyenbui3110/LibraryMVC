...
public class BorrowingHistoryConfiguration: IEntityTypeConfiguration<BorrowingHistory>
{
    public void Configure(EntityTypeBuilder<BorrowingHistory> builder)
    {
        ...
        builder.HasOne(b => b.Borrower).WithMany(b => b.BorrowingHistories).HasForeignKey(b => b.LibraryCardId).HasPrincipalKey(b => b.LibraryCardId);        
        builder.HasOne(b => b.LibraryItem).WithMany(b => b.BorrowingHistories).HasForeignKey(b => b.LibraryItemId).HasPrincipalKey(b => b.Id);
    }
}